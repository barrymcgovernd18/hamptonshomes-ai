...
import { HOMEPAGE_PROOF } from "@/lib/seo-copy";
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          <div className="grid gap-10 md:grid-cols-12 md:items-end md:gap-16">
            <div className="md:col-span-7">
              <p className="mb-5 text-[11px] uppercase tracking-[0.28em] text-ocean">{HOMEPAGE_PROOF.eyebrow}</p>
              <h2 className="font-serif text-4xl leading-tight text-ink md:text-5xl">{HOMEPAGE_PROOF.headline}</h2>
              <p className="mt-7 max-w-2xl text-[15px] leading-[1.9] text-ink-muted">{HOMEPAGE_PROOF.body}</p>
            </div>
            <div className="flex flex-col gap-4 md:col-span-4 md:col-start-9">
              <Link href={HOMEPAGE_PROOF.primaryHref} className="inline-block bg-ocean px-7 py-3.5 text-center text-[11px] uppercase tracking-[0.24em] text-paper hover:bg-ocean-deep">
                {HOMEPAGE_PROOF.primaryCta}
              </Link>
              <a href={HOMEPAGE_PROOF.secondaryHref} target="_blank" rel="noopener" className="inline-block border-b border-ocean pb-1 text-sm text-ocean hover:border-ink hover:text-ink">
                {HOMEPAGE_PROOF.secondaryCta} <span aria-hidden="true">↗</span>
              </a>
            </div>
          </div>
        </div>
