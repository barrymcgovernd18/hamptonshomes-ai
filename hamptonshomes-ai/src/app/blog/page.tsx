        ...
        <section className="pb-20">
          <div className="max-w-7xl mx-auto px-8">
            <Link
              ...
              className="block border border-white/5 hover:border-ocean/30 transition-all duration-700 group overflow-hidden"
            >
              {latest.image && (
                <div className="relative h-64 md:h-96 overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-12 md:p-16">
                    ...
                    <h2 className="font-serif text-2xl md:text-4xl text-white group-hover:text-ocean transition-colors duration-500 leading-snug mb-4">
                      {latest.title}
                    </h2>
              ...
              {!latest.image && (
                <div className="p-12 md:p-16">
                  ...
                  <h2 className="font-serif text-2xl md:text-4xl text-white group-hover:text-ocean transition-colors duration-500 leading-snug mb-6">
                    {latest.title}
                  </h2>
                  <p className="text-white/40 text-[15px] leading-relaxed max-w-2xl">
                    {latest.excerpt}
                  </p>
                  <p className="text-white/20 text-[11px] tracking-[0.2em] uppercase mt-8 group-hover:text-ocean/50 transition-colors duration-500">
                    Read Report →
                  </p>
                </div>
              )}
              ...
              {rest.map((post) => (
                ...
                >
                  ...
                  <div className="p-10">
                    ...
                    <h3 className="font-serif text-xl text-white group-hover:text-ocean transition-colors duration-500 leading-snug mb-4">
                      {post.title}
                    </h3>
                    <p className="text-white/30 text-[14px] leading-relaxed">
                      {post.excerpt}
                    </p>
                    <p className="text-white/15 text-[11px] tracking-[0.2em] uppercase mt-6 group-hover:text-ocean/40 transition-colors duration-500">
                      Read →
                    </p>
                  </div>
                </Link>
