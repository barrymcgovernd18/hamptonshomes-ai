      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-ink-muted leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-4"><strong className="text-ink">Account Information:</strong> If you create an account, we may collect your name, email address, and authentication credentials. You may also sign in through third-party providers (Apple, Google), in which case we receive the information you authorize those providers to share.</p>
            <p className="mb-4"><strong className="text-ink">Usage Data:</strong> We collect information about how you interact with our app and website, including pages viewed, articles read, features used, and general usage patterns.</p>
            <p className="mb-4"><strong className="text-ink">Device Information:</strong> We may collect device type, operating system, app version, and general location (country or region) for analytics and to improve our services.</p>
            <p><strong className="text-ink">Payment Information:</strong> Subscription and in-app purchase payments are processed by Apple through the App Store. We do not collect or store your payment card details.</p>
          </section>

          <section>
            <h2 className="font-serif text-xl text-ink mb-3">How We Use Your Information</h2>
            <p>We use the information we collect to:</p>
            <ul className="list-disc list-inside space-y-2 mt-3 text-ink-muted">
          ...
          <section>
            <h2 className="font-serif text-xl text-ink mb-3">Data Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink mb-3">Data Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink mb-3">Children&apos;s Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink mb-3">Changes to This Policy</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl text-ink mb-3">Contact Us</h2>
            <p>
